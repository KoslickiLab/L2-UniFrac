...
if __name__ == '__main__':
	...
	parser.add_argument('-b', '--biom_file', metavar='', help="Biom file: Sample dataset in the BIOM file format")
	parser.add_argument('-t', '--tree_file', metavar='', help="Tree file: OTU Tree in TREE file format")
	parser.add_argument('-m', '--metadata_file', metavar='', help="Metadata file: Sample names will be the first column and body habitats are the third column, following 'OBERON:'")
	parser.add_argument('-x', '--taxonomy_file', metavar='', help="Taxonomy file: Conversion between Tree Node and Taxonomy")
