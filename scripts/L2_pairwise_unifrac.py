...
if __name__ == "__main__":
	...
	if group_num:
		Group_Pairwise('../data/47422_otu_table.biom', '../data/trees/gg_13_5_otus_99_annotated.tree', '../data/metadata/P_1928_65684500_raw_meta.txt', group_num,
                       '../data/L2-UniFrac-Out.csv', debug)
	else:
		Total_Pairwise('../data/47422_otu_table.biom', '../data/trees/gg_13_5_otus_99_annotated.tree',
                       '../data/L2-UniFrac-Out.csv', debug)
